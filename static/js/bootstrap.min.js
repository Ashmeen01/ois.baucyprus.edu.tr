...
/*top*/
$(document).ready(function(){$("#back-top").hide();$(function(){$(window).scroll(function(){if($(this).scrollTop()>100){$("#back-top").fadeIn()}else{$("#back-top").fadeOut()}});$("#back-top a").click(function(){$("body,html").animate({scrollTop:0},600);return false})})});
...
;(function( $ ){
  ...
  var privateMethods = {
    ...
    execute: function(action, name, callback) {
      ...
      if('open' === action || ('toogle' === action && !$menu.is(':visible'))) {
        ...
        $html.css('overflow-x', 'hidden !important').scrollTop(scrollTop);
  ...
  $.fn.sidr = function( options ) {
    ...
    var settings = $.extend( {
      ...
      speed         : 230,    // Accepts standard jQuery effects speeds (i.e. fast, normal or milliseconds)
...
$(function()
{
    $.each($(".navbar-left li a"), function(i,a){
        var href=$(a).attr('href').replace('#','');
        $(a).sidr({name: href,side: 'left'});
    });
...
TableThing = function(params) {
    ...
    this.fixThead = function() {
        ...
        $(window).scroll(function() {
            ...
            if (settings.table.offset()!=null && windowTop > settings.table.offset().top) {
